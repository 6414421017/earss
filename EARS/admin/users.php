...
<html lang="eng">
	...
	<body>
		...
		<div class="container-fluid admin" >
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content panel-warning">
						<div class="modal-header panel-heading">
							...
							<h4 class="modal-title" id="manage_userlabel">แก้ไขแอดมิน</h4>
						</div>
			...
			<div class="alert alert-primary">บัญชีผู้ดูแลระบบ</div>
					...
					<div class="modal-content panel-primary">
						...
						<form id="user-frm">
							...
							<div class="modal-footer">
								<button  class="btn btn-primary" name="save">บันทึก</button>
							</div>
						</form>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				$.ajax({
					...
					success:function(resp){
						if(typeof resp !=undefined){
							...
							$('#manage_user .modal-title').html('แก้ไขข้อมูลแอดมิด')
			...
			$('#new_user').click(function(){
				...
				$('[name="lastname"]').val('')
				$('[name="username"]').val('')
				$('#manage_user .modal-title').html('เพิ่มแอดมินใหม่')
				$('#manage_user').modal('show')
			})
		});
	</script>
